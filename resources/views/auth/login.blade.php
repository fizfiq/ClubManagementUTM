...
<head>
    ...
    <title>Log in</title><!--begin::Primary Meta Tags-->
...
<body class="login-page bg-body-secondary">
    <div class="login-box">
        <div class="login-logo"><a href=""><b>Login CUC</b></a></div><!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="{{ asset('login') }}" method="post">
                    {{ csrf_field() }}
                    <div class="input-group mb-3"><input type="email" class="form-control" required name="email" placeholder="Email">
                ...
                <p class="mb-1"><a href="{{ asset('forgot-password') }}">I forgot my password</a></p>
