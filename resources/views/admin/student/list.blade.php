                                    ...
                                    <div class="card-body">
                                      <div class="row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <a href="{{ asset('admin/student/list') }}" class="btn btn-success" style="margin-top: 23px;">Reset</a>
                                        </div>
                                      </div>                                          
                                    </div><!--end::Body-->
                                </form><!--end::Form-->
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ asset('admin/student/edit/'.$value->id) }}" class="btn btn-primary">Edit</a>
                                                    <a href="{{ asset('admin/student/delete/'.$value->id) }}" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
